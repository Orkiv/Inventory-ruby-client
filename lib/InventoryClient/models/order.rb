...
module InventoryClient
  ...
  class Order
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'itemIDs')
        if (value = attributes[:'itemIDs']).is_a?(Array)
          self.item_i_ds = value
        end
      end
    ...
    def hash
      [order_id, info_email, info_first, info_last, phone, shipset, info_adr1, info_adr2, info_cty, info_zip, state, info_sadr1, info_sadr2, info_scty, info_szip, sstate, tax_amount, shipping_amount, amount_total, item_i_ds].hash
    end
